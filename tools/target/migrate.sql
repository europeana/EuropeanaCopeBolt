...
-- and now replace all id's in relations --
...
-- and now replace all id's in taxonomy --
...
-- -- remove subsite columns from relations and taxonomy --
-- ALTER TABLE bolt_relations DROP subsite;
-- ALTER TABLE bolt_taxonomy DROP subsite;

-- -- finally remove all subsite_id columns --
