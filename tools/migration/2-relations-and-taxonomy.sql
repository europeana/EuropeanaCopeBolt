...
UPDATE bolt_relations r, bolt_pages x SET r.from_id = x.id WHERE x.subsite_id = r.from_id AND x.subsite = r.subsite AND r.from_contenttype = 'structures';
...
UPDATE bolt_relations r, bolt_pages x SET r.to_id = x.id WHERE x.subsite_id = r.to_id AND x.subsite = r.subsite AND r.to_contenttype = 'structures';
...
UPDATE bolt_relations r SET r.to_contenttype = 'projects' WHERE r.to_contenttype = 'taskforces';
UPDATE bolt_relations r SET r.to_contenttype = 'pages' WHERE r.to_contenttype = 'pro-structures';
UPDATE bolt_relations r SET r.to_contenttype = 'pages' WHERE r.to_contenttype = 'pro-structures';
UPDATE bolt_relations r SET r.to_contenttype = 'pages' WHERE r.to_contenttype = 'labs-structures';
UPDATE bolt_relations r SET r.to_contenttype = 'pages' WHERE r.to_contenttype = 'labs-structures';
UPDATE bolt_relations r SET r.to_contenttype = 'pages' WHERE r.to_contenttype = 'research-structures';
UPDATE bolt_relations r SET r.to_contenttype = 'pages' WHERE r.to_contenttype = 'research-structures';
...
UPDATE bolt_taxonomy t, bolt_pages c SET t.content_id = c.id WHERE c.subsite_id = t.content_id AND c.subsite = t.subsite AND t.contenttype = 'structures';
